                            ...
                            <ul class="sub-menu ">
                                <li class="nav-item active open ">
                                    <a href="<?php echo base_url('/RegistroDocente/'); ?>" class="nav-link ">
                                        <i class="icon-user"></i>
                                        <span class="title">Docentes
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="<?php echo base_url('/REGISTROSECRETARIA/'); ?>" class="nav-link ">
                                        <i class="icon-tag"></i>
                                ...
                                <li class="nav-item  ">
                                    <a href="<?php echo base_url('/REGISTRODIRECTIVO/'); ?>" class="nav-link ">
                                        <i class="icon-user"></i>
                                        <span class="title">Directivos
