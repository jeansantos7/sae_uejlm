                        ...
                        <div role="tabpanel" class="tab-pane" id="profile">
                         ...
                         <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="telf_Secretaria" name="telf_Secretaria" placeholder="valor de la pension">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1"> Correo</label>
                                        <input type="email" class="form-control" id="correo_Secretaria" name="correo_Secretaria" placeholder="valor de la pension">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="user_Secretaria" name="user_Secretaria" placeholder="Usuario">
                                    </div>
                                    <div class="form-group">
