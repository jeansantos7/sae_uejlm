			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="<?php echo base_url('/RegistroDirectivo/'); ?>"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Directivos</a>
						</li>
						<li>
							<a href="<?php echo base_url('/RegistroSecretaria/'); ?>"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Profesores</a>
						</li>

						<li>
							<a href="teacher.html"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Secretaria</a>
						</li>
