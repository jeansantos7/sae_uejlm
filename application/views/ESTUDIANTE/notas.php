        ...
        <div class="row">
            <div class="col-xs-12">
                <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                    ...
                    <li class=""><a href="#list" data-toggle="tab">Generar Reporte Notas</a></li>
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade" id="list">
                        ...
                        <iframe class="" width="100%" height="65%" name="nombre_iframe" src="<?php echo base_url("/ReportesGP2/reporteNotas");?>"></iframe>
