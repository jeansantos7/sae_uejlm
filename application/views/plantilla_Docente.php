              ...
              <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item active open ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-bag"></i>
                                <span class="title">Mi Curso</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="<?php echo base_url('/Docente/CursoTutor'); ?>" class="nav-link ">
                                        <i class="icon-docs"></i>
                                        <span class="title">Lista de Estudiantes</span>
                                    </a>
                                </li>
                            ...
                            <a href="<?php echo base_url('/Asignacion/'); ?>" class="nav-link nav-toggle">
                                ...
                                <span class="title">Libretas</span>
                                <span class="arrow"></span>
                            </a>
